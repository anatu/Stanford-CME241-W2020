'''
CLASS CODE - CME241
MDP Data Structure and Class Functions
Annotated by Anand Natu for learning purposes
'''
...
class MDP(Generic[S, A]):
    ...
    def get_act_value_func_dict(self, pol: Policy)\
        ...
        # Get dict of state value functions for the policy
        v_dict = self.get_value_func_dict(pol)
        # Compute expected reward for each action, and store as a
